...
class credentialutil(object):
    ...
    def load(cls, app_config_path):
        ...
        #delete: 2 lines
        #import os
        #logging.info(f"{os.path.dirname(os.path.realpath(__file__))}")
        # app_config_path = r"C:\Users\Evgeny\Documents\Projects\ebay-oauth-python-client\test\config\ebay-config-sample.json"
